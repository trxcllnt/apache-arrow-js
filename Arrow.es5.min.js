...
function ea(a,b,c){b=k.w(b);var f=b.next();k.C.Yd(f);if(f.done)a.m=f.value,a.j=c;else return a.ra=b,p(a,f.value,c)}ca.prototype.i=function(a){this.j=a};function ha(a,b){a.ua=0;a.ia=b||0}function ia(a){a.ua=0;var b=a.fa.Zd;a.fa=null;return b}function ja(a){a.$d=[a.fa];a.ua=0;a.ia=0}function ka(a){var b=a.$d.splice(0)[0];(b=a.fa=a.fa||b)?b.de?a.j=a.ua||a.ia:void 0!=b.i&&a.ia<b.i?(a.j=b.i,a.fa=null):a.j=a.ia:a.j=0}function la(a){this.J=new ca;this.Nf=a}
la.prototype.kb=function(a){da(this.J);if(this.J.ra)return ma(this,this.J.ra.next,a,this.J.kb);this.J.kb(a);return na(this)};function pa(a,b){da(a.J);var c=a.J.ra;if(c)return ma(a,"return"in c?c["return"]:function(f){return{value:f,done:!0}},b,a.J.return);a.J.return(b);return na(a)}la.prototype.mb=function(a){da(this.J);if(this.J.ra)return ma(this,this.J.ra["throw"],a,this.J.kb);this.J.mb(a);return na(this)};
function ma(a,b,c,f){try{var d=b.call(a.J.ra,c);k.C.Yd(d);if(!d.done)return a.J.ib=!1,d;var e=d.value}catch(h){return a.J.ra=null,a.J.mb(h),na(a)}a.J.ra=null;f.call(a.J,e);return na(a)}function na(a){for(;a.J.j;)try{var b=a.Nf(a.J);if(b)return a.J.ib=!1,{value:b.value,done:!1}}catch(c){a.J.m=void 0,a.J.mb(c)}a.J.ib=!1;if(a.J.fa){b=a.J.fa;a.J.fa=null;if(b.de)throw b.Zd;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
k.Me=!1;
k.ee("Promise",function(a){function b(h){this.lb=0;this.vc=void 0;this.Ja=[];var l=this.jc();try{h(l.resolve,l.reject)}catch(m){l.reject(m)}}function c(){this.ta=null}function f(h){return h instanceof b?h:new b(function(l){l(h)})}if(a&&!k.Me)return a;c.prototype.xd=function(h){if(null==this.ta){this.ta=[];var l=this;this.yd(function(){l.yf()})}this.ta.push(h)};var d=k.global.setTimeout;c.prototype.yd=function(h){d(h,0)};c.prototype.yf=function(){for(;this.ta&&this.ta.length;){var h=this.ta;this.ta=
...
k.u=function(a){return k.zd(new qa(new la(a)))};k.Ia=function(a){k.N();var b=a[Symbol.asyncIterator];return void 0!==b?b.call(a):new ra(k.w(a))};function ra(a){this[Symbol.asyncIterator]=function(){return this};this[Symbol.iterator]=function(){return a};this.next=function(b){return Promise.resolve(a.next(b))};void 0!==a["throw"]&&(this["throw"]=function(b){return Promise.resolve(a["throw"](b))});void 0!==a["return"]&&(this["return"]=function(b){return Promise.resolve(a["return"](b))})}
...
function Ba(a){var b=a.W.first();try{var c=a.be[b.method](b.za);if(c.value instanceof q)switch(c.value.action){case 0:Promise.resolve(c.value.value).then(function(f){b.resolve({value:f,done:c.done});va(a.W);xa(a)},function(f){b.reject(f);va(a.W);xa(a)}).catch(a.gc);break;case 1:a.ba=k.Ia(c.value.value);b.method="next";b.za=void 0;xa(a);break;case 2:Promise.resolve(c.value.value).then(function(f){b.method="next";b.za=f;xa(a)},function(f){b.method="throw";b.za=f;xa(a)}).catch(a.gc);break;default:throw Error("Unrecognized AsyncGeneratorWrapper$ActionEnum");
...
Da.prototype.equals=function(a){return this.low==a.low&&this.high==a.high};var Ea=new Da(0,0);function Fa(){this.a=new Ga(new Uint8Array(1024));this.M=1024;this.jb=1;this.pa=null;this.yc=0;this.hb=!1;this.qc=0;this.nb=[];this.xc=0;this.Ga=!1}g=Fa.prototype;g.clear=function(){this.a.clear();this.M=this.a.F.length;this.jb=1;this.pa=null;this.yc=0;this.hb=!1;this.qc=0;this.nb=[];this.xc=0;this.Ga=!1};function Ha(a){return a.a.ma().subarray(a.a.position(),a.a.position()+a.offset())}
function Ia(a,b,c){b>a.jb&&(a.jb=b);for(var f=~(a.a.F.length-a.M+c)+1&b-1;a.M<f+b+c;){var d=a.a.F.length,e=a,h=a.a,l=h.F.length;if(l&3221225472)throw Error("FlatBuffers: cannot grow buffer beyond 2 gigabytes.");var m=l<<1,n=new Ga(new Uint8Array(m));n.setPosition(m-l);n.ma().set(h.ma(),m-l);e.a=n;a.M+=a.a.F.length-d}Ja(a,f)}function Ja(a,b){for(var c=0;c<b;c++)a.a.Oa(--a.M,0)}g.Oa=function(a){this.a.Oa(--this.M,a)};g.zc=function(a){this.a.zc(this.M-=2,a)};g.da=function(a){this.a.da(this.M-=4,a)};
g.qa=function(a){this.a.qa(this.M-=8,a)};function Ka(a,b){Ia(a,2,0);a.zc(b)}function La(a,b,c,f){if(a.Ga||c!=f)Ia(a,1,0),a.Oa(c),a.slot(b)}function Ma(a,b,c){if(a.Ga||b!=c)Ka(a,b),a.slot(0)}function Na(a,b,c,f){if(a.Ga||c!=f)Ia(a,4,0),a.da(c),a.slot(b)}function Oa(a,b,c,f){if(a.Ga||!c.equals(f))Ia(a,8,0),a.qa(c),a.slot(b)}function Pa(a,b,c){if(a.Ga||0!=c)Qa(a,c),a.slot(b)}function Ra(a){if(a.hb)throw Error("FlatBuffers: object serialization must not be nested.");}g.slot=function(a){this.pa[a]=this.offset()};
...
a.offset()-b));a.hb=!1;return b}g.finish=function(a,b){if(b){Ia(this,this.jb,8);if(4!=b.length)throw Error("FlatBuffers: file identifier must be length 4");for(var c=3;0<=c;c--)this.Oa(b.charCodeAt(c))}Ia(this,this.jb,4);Qa(this,a);this.a.setPosition(this.M)};function Ta(a,b,c,f){Ra(a);a.xc=c;Ia(a,4,b*c);Ia(a,f,b*c)}function Ua(a){a.da(a.xc);return a.offset()}
function Va(a,b){if(b instanceof Uint8Array)var c=b;else{c=[];for(var f=0;f<b.length;){var d=b.charCodeAt(f++);if(!(55296>d||56320<=d)){var e=b.charCodeAt(f++);d=(d<<10)+e+-56613888}128>d?c.push(d):(2048>d?c.push(d>>6&31|192):(65536>d?c.push(d>>12&15|224):c.push(d>>18&7|240,d>>12&63|128),c.push(d>>6&63|128)),c.push(d&63|128))}}Ia(a,1,0);a.Oa(0);Ta(a,1,c.length,1);a.a.setPosition(a.M-=c.length);f=0;b=a.M;for(d=a.a.ma();f<c.length;f++)d[b++]=c[f];return Ua(a)}
g.oa=function(a,b){return 0==a&&0==b?Ea:new Da(a,b)};function Ga(a){this.F=a;this.rc=0}g=Ga.prototype;g.clear=function(){this.rc=0};g.ma=function(){return this.F};g.position=function(){return this.rc};g.setPosition=function(a){this.rc=a};function Wa(a,b){return a.F[b]}function Sa(a,b){return(a.F[b]|a.F[b+1]<<8)<<16>>16}g.v=function(a){return this.F[a]|this.F[a+1]<<8|this.F[a+2]<<16|this.F[a+3]<<24};function Xa(a,b){return new Da(a.v(b),a.v(b+4))}g.Oa=function(a,b){this.F[a]=b};
...
TextEncoder:hb);var nb=Object.freeze({done:!0,value:void 0});function ob(a){this.Ta=a}k.global.Object.defineProperties(ob.prototype,{schema:{configurable:!0,enumerable:!0,get:function(){return this.Ta.schema}},Ad:{configurable:!0,enumerable:!0,get:function(){return this.Ta.batches||[]}},dictionaries:{configurable:!0,enumerable:!0,get:function(){return this.Ta.dictionaries||[]}}});function pb(){}pb.prototype.tee=function(){return qb(this).tee()};function rb(a,b,c){return rb(a.Oc||(a.Oc=a.toNodeStream()),b,c)}
pb.prototype.pipeTo=function(a,b){return qb(this).pipeTo(a,b)};pb.prototype.pipeThrough=function(a,b){return qb(this).pipeThrough(a,b)};function qb(a){return a.Ec||(a.Ec=a.toDOMStream())}k.l();k.N();function sb(){var a=this;this.B=[];this.Ma=[];this.Tb=new Promise(function(b){return a.X=b})}k.b(sb,pb);sb.prototype.cancel=function(a){var b=this;return k.u(function(c){return p(c,b.return(a),0)})};
sb.prototype.write=function(a){if(!this.X)throw Error(this+" is closed");0>=this.Ma.length?this.B.push(a):this.Ma.shift().resolve({done:!1,value:a})};sb.prototype.abort=function(a){this.X&&(0>=this.Ma.length?this.Vb={error:a}:this.Ma.shift().reject({done:!0,value:a}))};sb.prototype.close=function(){if(this.X){for(var a=this.Ma;0<a.length;)a.shift().resolve(nb);this.X();this.X=void 0}};sb.prototype[Symbol.asyncIterator]=function(){return this};g=sb.prototype;
...
function x(a){return z(Uint8Array,a)}function Qb(a){return z(Bb,a)}function Sb(a){a.next();return a}
function Tb(a,b){var c,f;return k.C.H(Tb,function(d){c=function l(h){return k.C.H(l,function(m){return p(m,h,0)})};f="string"===typeof b?c(b):ArrayBuffer.isView(b)?c(b):b instanceof ArrayBuffer?c(b):b instanceof Kb?c(b):Fb(b)?b:c(b);k.l();k.D();return ea(d,Sb(function m(l){var n,r,v;return k.C.H(m,function(y){1==y.j&&(n=null);if(5!=y.j)return r=l,v=r.next,p(y,z(a,n),5);n=v.call(r,y.m);if(!n.done)return y.i(2);y.j=0})}(f[Symbol.iterator]())),0)})}function Ub(a){return Tb(Uint8Array,a)}
...
new q(1,Sb(function Rb(aa){var T,oa,Ie;return k.C.H(Rb,function(hc){1==hc.j&&(T=null);if(5!=hc.j)return oa=aa,Ie=oa.next,p(hc,T&&T.value,5);T=Ie.call(oa,hc.m);if(!T.done)return hc.i(2);hc.j=0})}(y[Symbol.iterator]()))),0)})}())},r="string"===typeof b?m(b):ArrayBuffer.isView(b)?m(b):b instanceof ArrayBuffer?m(b):b instanceof Kb?m(b):Fb(b)?n(b):Gb(b)?b:m(b),k.l(),k.N(),p(v,new q(1,Sb(function(y){return new wa(function Z(){var fa,C,aa,Rb,T;return k.C.H(Z,function(oa){switch(oa.j){case 1:fa=null;case 2:return C=
q,aa=2,Rb=y,T=Rb.next,p(oa,new q(0,z(a,fa)),6);case 6:return p(oa,new C(aa,T.call(Rb,oa.m)),5);case 5:fa=oa.m,fa.done?oa.j=0:oa.i(2)}})}())}(r[Symbol.asyncIterator]()))),0)}})}())}function Wb(a){return Vb(Uint8Array,a)}function Xb(a,b,c){if(0!==a){c=c.slice(0,b+1);for(var f=-1;++f<=b;)c[f]+=a}return c}function Yb(a,b){var c=0,f=a.length;if(f!==b.length)return!1;if(0<f){do if(a[c]!==b[c])return!1;while(++c<f)}return!0}var B={};B.compareArrayLike=Yb;B.joinUint8Arrays=Nb;B.memcpy=Mb;
...
function cc(a){this.source=a;this.Fa=this.Ea=null;try{this.Ie=!!(this.ka=dc(this))}catch(b){this.Ie=!(this.ka=ec(this))}}cc.prototype.releaseLock=function(){this.ka&&this.ka.releaseLock();this.ka=this.Ea=this.Fa=null};cc.prototype.cancel=function(a){var b=this,c,f,d;return k.u(function(e){if(1==e.j)return c=b,f=c.ka,d=c.source,f?p(e,f.cancel(a).catch(function(){}),3):e.i(2);d&&d.locked&&b.releaseLock();e.j=0})};
cc.prototype.read=function(a){var b=this,c,f;return k.u(function(d){switch(d.j){case 1:return 0===a?d.return({done:null==b.ka,value:new Uint8Array(0)}):b.Ie&&"number"===typeof a?p(d,fc(b,a),4):p(d,ec(b).read(),5);case 4:c=d.m;d.i(3);break;case 5:c=d.m;case 3:return f=c,!f.done&&(f.value=x(f)),d.return(f)}})};function ec(a){a.Ea&&a.releaseLock();a.Fa||(a.Fa=a.source.getReader(),a.Fa.closed.catch(function(){}));return a.ka=a.Fa}
function dc(a){a.Fa&&a.releaseLock();a.Ea||(a.Ea=a.source.getReader({mode:"byob"}),a.Ea.closed.catch(function(){}));return a.ka=a.Ea}function fc(a,b){return k.u(function(c){return 1==c.j?p(c,gc(dc(a),new ArrayBuffer(b),0,b),2):c.return(c.m)})}k.global.Object.defineProperties(cc.prototype,{closed:{configurable:!0,enumerable:!0,get:function(){return this.ka?this.ka.closed.catch(function(){}):Promise.resolve()}}});
...
g.getInternal=function(a,b,c){return a.K[b].get(c)};g.isValidInternal=function(a,b,c){return a.K[b].isValid(c)};g.indexOfInternal=function(a,b,c,f){a=a.K;--b;var d=a.length,e=c;for(c=0;++b<d;){if(~(e=a[b].indexOf(f,e)))return c+e;e=0;c+=a[b].length}return-1};g.ac=function(a,b,c){for(var f=[],d=a.chunks,e=a.Sb,h=-1,l=d.length;++h<l;){var m=d[h],n=m.length,r=e[h];if(r>=c)break;b>=r+n||(r>=b&&r+n<=c?f.push(m):f.push(m.slice(Math.max(0,b-r),Math.min(c-r,n))))}return a.clone(f)};
k.global.Object.defineProperties(O.prototype,{type:{configurable:!0,enumerable:!0,get:function(){return this.ga}},length:{configurable:!0,enumerable:!0,get:function(){return this.Ua}},chunks:{configurable:!0,enumerable:!0,get:function(){return this.K}},typeId:{configurable:!0,enumerable:!0,get:function(){return this.ga.typeId}},VectorName:{configurable:!0,enumerable:!0,get:function(){return"Chunked<"+this.ga+">"}},data:{configurable:!0,enumerable:!0,get:function(){return this.K[0]?this.K[0].data:
null}},ArrayType:{configurable:!0,enumerable:!0,get:function(){return this.ga.ArrayType}},numChildren:{configurable:!0,enumerable:!0,get:function(){return this.Xb}},stride:{configurable:!0,enumerable:!0,get:function(){return this.K[0]?this.K[0].stride:1}},byteLength:{configurable:!0,enumerable:!0,get:function(){return this.K.reduce(function(a,b){return a+b.byteLength},0)}},nullCount:{configurable:!0,enumerable:!0,get:function(){var a=this.wa;0>a&&(this.wa=a=this.K.reduce(function(b,c){return b+c.nullCount},
0));return a}},indices:{configurable:!0,enumerable:!0,get:function(){if(M.isDictionary(this.ga)){if(!this.Lc){var a=this.K;this.Lc=1===a.length?a[0].indices:O.concat.apply(O,k.o(a.map(function(b){return b.indices})))}return this.Lc}return null}},dictionary:{configurable:!0,enumerable:!0,get:function(){return M.isDictionary(this.ga)?this.K[this.K.length-1].data.dictionary:null}}});function Jh(a,b,c){b.set(a,c);return c+a.length}
function Ih(a,b,c){for(var f=-1,d=a.length;++f<d;)b[c++]=a[f];return c};function Kh(a,b,c){b=void 0===b?[]:b;b=O.flatten.apply(O,k.o(b));O.call(this,a.type,b,c);this.Sa=a;if(1===b.length&&!(this instanceof Lh))return new Lh(a,b[0],this.Sb)}k.b(Kh,O);
Kh.new=function(a,b,c){for(var f=[],d=2;d<arguments.length;++d)f[d-2]=arguments[d];f=O.flatten(Array.isArray(b)?[].concat(k.o(b),k.o(f)):b instanceof D?[b].concat(k.o(f)):[D.new.apply(D,[b].concat(k.o(f)))]);"string"===typeof a?a=new P(a,f[0].data.type,!0):!a.nullable&&f.some(function(e){return 0<e.nullCount})&&(a=a.clone({nullable:!0}));return new Kh(a,f)};Kh.prototype.clone=function(a){a=void 0===a?this.K:a;return new Kh(this.Sa,a)};
Kh.prototype.getChildAt=function(a){if(0>a||a>=this.numChildren)return null;var b=this.ea||(this.ea=[]),c;if(c=b[a])return c;if(c=(this.type.children||[])[a]){var f=this.K.map(function(d){return d.getChildAt(a)}).filter(function(d){return null!=d});if(0<f.length)return b[a]=new Kh(c,f)}return null};
k.global.Object.defineProperties(Kh.prototype,{field:{configurable:!0,enumerable:!0,get:function(){return this.Sa}},name:{configurable:!0,enumerable:!0,get:function(){return this.Sa.name}},nullable:{configurable:!0,enumerable:!0,get:function(){return this.Sa.nullable}},metadata:{configurable:!0,enumerable:!0,get:function(){return this.Sa.metadata}}});function Lh(a,b,c){a=Kh.call(this,a,[b],c)||this;a.ub=b;return a}k.b(Lh,Kh);g=Lh.prototype;g.search=function(a,b){return b?b(this,0,a):[0,a]};
...
g.visitInt=function(a,b){b=void 0===b?gj(this):b;var c=b.nullCount;return L.Int(a,0,b.length,c,this.P(a,c),this.U(a))};g.visitFloat=function(a,b){b=void 0===b?gj(this):b;var c=b.nullCount;return L.Float(a,0,b.length,c,this.P(a,c),this.U(a))};g.visitUtf8=function(a,b){b=void 0===b?gj(this):b;var c=b.nullCount;return L.Utf8(a,0,b.length,c,this.P(a,c),this.La(a),this.U(a))};g.visitBinary=function(a,b){b=void 0===b?gj(this):b;var c=b.nullCount;return L.Binary(a,0,b.length,c,this.P(a,c),this.La(a),this.U(a))};
...
g.visitFixedSizeList=function(a,b){b=void 0===b?gj(this):b;var c=b.nullCount;return L.FixedSizeList(a,0,b.length,c,this.P(a,c),this.visit(a.children[0]))};g.visitMap=function(a,b){b=void 0===b?gj(this):b;var c=b.nullCount;return L.Map(a,0,b.length,c,this.P(a,c),this.La(a),this.visit(a.children[0]))};function gj(a){return a.$[++a.Jf]}function hj(a){return a.buffers[++a.hf]}g.P=function(a,b){var c=void 0===c?hj(this):c;return 0<b&&this.U(a,c)||new Uint8Array(0)};g.La=function(a){return this.U(a,void 0)};
g.sc=function(a){return this.U(a,void 0)};g.U=function(a,b){a=void 0===b?hj(this):b;b=a.offset;return this.ma.subarray(b,b+a.length)};function ij(a,b,c,f){fj.call(this,new Uint8Array(0),b,c,f);this.Kb=a}k.b(ij,fj);ij.prototype.P=function(a,b){a=hj(this).offset;return 0>=b?new Uint8Array(0):qd(this.Kb[a])};ij.prototype.La=function(){var a=hj(this).offset;return z(Uint8Array,z(Int32Array,this.Kb[a]))};ij.prototype.sc=function(a){var b=hj(this).offset;return z(Uint8Array,z(a.ArrayType,this.Kb[b]))};
...
function Fj(a,b,c){this.Wb=b;this.Rb=c;this.Ua="number"===typeof a?a:a.low}k.global.Object.defineProperties(Fj.prototype,{$:{configurable:!0,enumerable:!0,get:function(){return this.Wb}},length:{configurable:!0,enumerable:!0,get:function(){return this.Ua}},buffers:{configurable:!0,enumerable:!0,get:function(){return this.Rb}}});function ck(a,b,c){this.Te=a;this.Ye=void 0===c?!1:c;this.Xe="number"===typeof b?b:b.low}
...
function Bk(a){zk.call(this,new Uint8Array(0));this.I=!1;this.sb=[];this.la=this.Fc=0;this.Ta=a instanceof ob?a:new ob(a)}k.b(Bk,zk);
Bk.prototype.next=function(){var a=this.Ta;if(!this.I)return this.I=!0,{done:!1,value:Zj.fromJSON(a.schema,H.Schema)};if(this.la<a.dictionaries.length)return a=a.dictionaries[this.la++],this.sb=a.data.columns,{done:!1,value:Zj.fromJSON(a,H.DictionaryBatch)};if(this.Fc<a.Ad.length)return a=a.Ad[this.Fc++],this.sb=a.columns,{done:!1,value:Zj.fromJSON(a,H.RecordBatch)};this.sb=[];return nb};
...
function Rk(a,b){var c,f;return k.C.H(Rk,function(d){1==d.j&&(c=-1,f=a.length/b);return++c<f?p(d,""+Cg.new(a.subarray((c+0)*b,(c+1)*b),!1),2):d.i(0)})};k.l();k.N();function Tk(a){this.Va=0;this.$a=!1;this.T=new Ri;this.I=null;this.Ra=[];this.zb=[];this.Ca=new Map;Db(a)||(a={autoDestroy:!0,Je:!1});this.qb="boolean"===typeof a.autoDestroy?a.autoDestroy:!0;this.cc="boolean"===typeof a.Je?a.Je:!1}k.b(Tk,pb);Tk.throughNode=function(){throw Error('"throughNode" not available in this environment');};Tk.throughDOM=function(){throw Error('"throughDOM" not available in this environment');};
...
g.close=function(){return this.reset().T.close()};g.abort=function(a){return this.reset().T.abort(a)};g.finish=function(){this.qb?this.close():this.reset(this.T,this.I);return this};
g.reset=function(a,b){a=void 0===a?this.T:a;b=void 0===b?null:b;a===this.T||a instanceof Ri?this.T=a:(this.T=new Ri,a&&Db(a)&&Cb(a.abort)&&Cb(a.getWriter)&&!(a instanceof pb)?this.toDOMStream({type:"bytes"}).pipeTo(a):a&&Db(a)&&Cb(a.end)&&Cb(a.write)&&"boolean"===typeof a.writable&&!(a instanceof pb)&&rb(this.toNodeStream({th:!1}),a));this.$a&&this.I&&this.Cb(this.I);this.$a=!1;this.Ra=[];this.zb=[];this.Ca=new Map;b&&b.compareTo(this.I)||(null===b?(this.Va=0,this.I=null):(this.$a=!0,this.I=b,this.dc(b)));
return this};g.write=function(a){var b=null;if(this.T){if(null===a||void 0===a||a instanceof S&&!(b=a.schema)||a instanceof Jk&&!(b=a.schema))return this.finish()&&void 0}else throw Error("RecordBatchWriter is closed");if(b&&!b.compareTo(this.I)){if(this.$a&&this.qb)return this.close();this.reset(this.T,b)}a instanceof Jk?a instanceof Wk||this.Rc(a):a instanceof S?this.writeAll(a.chunks):Fb(a)&&this.writeAll(a)};
g.Db=function(a){var b=Zj.encode(a),c=b.byteLength,f=this.cc?4:8,d=c+f+7&-8,e=d-c-f;a.headerType===H.RecordBatch?this.zb.push(new Ni(d,a.bodyLength,this.Va)):a.headerType===H.DictionaryBatch&&this.Ra.push(new Ni(d,a.bodyLength,this.Va));this.cc||Xk(this,Int32Array.of(-1));Xk(this,Int32Array.of(d-f));0<c&&Xk(this,b);return Yk(this,e)};function Xk(a,b){a.$a&&(b=x(b))&&0<b.byteLength&&(a.T.write(b),a.Va+=b.byteLength);return a}g.dc=function(a){this.Db(Zj.from(a))};
...
al.prototype.dc=function(){Yk(Xk(this,Ck),2)};al.prototype.Cb=function(a){var b=Li.encode(new Li(a,kd.V4,this.zb,this.Ra));return Xk(Xk(Xk(Tk.prototype.Cb.call(this,a),b),Int32Array.of(b.byteLength)),Ck)};function bl(){Tk.call(this);this.qb=!0;this.sa=[];this.Ba=[]}k.b(bl,Tk);bl.writeAll=function(a){return(new bl).writeAll(a)};g=bl.prototype;g.Db=function(){return this};g.Cb=function(){return this};g.dc=function(a){Xk(this,'{\n  "schema": '+JSON.stringify({fields:a.fields.map(cl)},null,2))};
g.Bb=function(a){0<a.dictionaries.size&&this.Ba.push(a);return this};g.Qc=function(a,b,c){c=void 0===c?!1:c;this.Ca.set(b,a.length+(this.Ca.get(b)||0));Xk(this,0===this.Ra.length?"    ":",\n    ");c=void 0===c?!1:c;var f=Qk.fb(new Kh(new P(""+b,a.type,0<a.nullCount),[a]));a=JSON.stringify({id:b,isDelta:c,data:{count:a.length,columns:f}},null,2);Xk(this,""+a);this.Ra.push(new Ni(0,0,0))};g.Rc=function(a){this.Bb(a);this.sa.push(a)};
...
function Vk(a,b){var c=b;b instanceof S&&(c=b.chunks,a.reset(void 0,b.schema));b=k.w(c);for(c=b.next();!c.done;c=b.next())a.write(c.value);return a.finish()}function Uk(a,b){var c,f,d;return k.u(function(e){switch(e.j){case 1:c=k.Ia(b);case 2:return p(e,c.next(),5);case 5:f=e.m;if(f.done){e.i(4);break}d=f.value;a.write(d);e.i(2);break;case 4:return e.return(a.finish())}})}
...
case 2:d=r.m;e=d.schema;h=[];if(!e){r.i(3);break}l=k.Ia(d);case 4:return p(r,l.next(),7);case 7:m=r.m;if(m.done){r.i(6);break}n=m.value;h.push(n);r.i(4);break;case 6:return r.return(new S(e,h));case 3:return r.return(S.empty())}})}(c.open())};S.fromAsync=function(a){return k.u(function(b){return 1==b.j?p(b,S.from(a),2):b.return(b.m)})};S.fromStruct=function(a){return S.new(a.data.childData,a.type.children)};
S.new=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];return new (Function.prototype.bind.apply(S,[null].concat(k.o(fl(Nh(b))))))};g=S.prototype;g.clone=function(a){a=void 0===a?this.K:a;return new S(this.I,a)};g.getColumn=function(a){return this.getColumnAt(this.getColumnIndex(a))};g.getColumnAt=function(a){return this.getChildAt(a)};g.getColumnIndex=function(a){return this.I.fields.findIndex(function(b){return b.name===a})};
g.getChildAt=function(a){if(0>a||a>=this.numChildren)return null;var b,c=this.I.fields,f=this.ea||(this.ea=[]);if(b=f[a])return b;if(b=c[a])if(c=this.K.map(function(d){return d.getChildAt(a)}).filter(function(d){return null!=d}),0<c.length)return f[a]=new Kh(b,c);return null};g.serialize=function(a,b){return(void 0===b||b?$k:al).writeAll(this).toUint8Array(!0)};g.count=function(){return this.Ua};
g.select=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];var f=this.I.fields.reduce(function(d,e,h){return d.set(e.name,h)},new Map);return this.selectAt.apply(this,k.o(b.map(function(d){return f.get(d)}).filter(function(d){return-1<d})))};g.selectAt=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];var f=this.I.selectAt.apply(this.I,k.o(b));return new S(f,this.K.map(function(d){var e=d.data.childData;return new Jk(f,d.length,b.map(function(h){return e[h]}).filter(Boolean))}))};
g.assign=function(a){var b=this,c=this.I.fields,f=k.w(a.schema.fields.reduce(function(h,l,m){var n=k.w(h),r=n.next().value;n=n.next().value;var v=c.findIndex(function(y){return y.name===l.name});~v?n[v]=m:r.push(m);return h},[[],[]])),d=f.next().value,e=f.next().value;f=this.I.assign(a.schema);d=[].concat(k.o(c.map(function(h,l,m,n){n=void 0===n?e[l]:n;return void 0===n?b.getColumnAt(l):a.getColumnAt(n)})),k.o(d.map(function(h){return a.getColumnAt(h)}))).filter(Boolean);return new (Function.prototype.bind.apply(S,
[null].concat(k.o(gl(f,d)))))};k.global.Object.defineProperties(S.prototype,{schema:{configurable:!0,enumerable:!0,get:function(){return this.I}},length:{configurable:!0,enumerable:!0,get:function(){return this.Ua}},chunks:{configurable:!0,enumerable:!0,get:function(){return this.K}},numCols:{configurable:!0,enumerable:!0,get:function(){return this.Xb}}});function bn(a){return a.type instanceof jf?Tl.from(a).then(function(b){return S.fromStruct(b)}):null};function Jk(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];c=b[0];if(b[1]instanceof L){var f=k.w(b);f.next();var d=f.next().value;f=f.next().value}else{d=c.fields;var e=k.w(b);e.next();b=e.next().value;e=e.next().value;d=L.Struct(new jf(d),0,b,0,null,e)}Tl.call(this,d,f);this.I=c}k.b(Jk,Tl);Jk.from=function(a){Fb(a.values);return S.from(a)};
Jk.new=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];c=k.w(Oh(b,[[],[]]));b=c.next().value;c=c.next().value.filter(function(f){return f instanceof D});return new (Function.prototype.bind.apply(Jk,[null].concat(k.o(el(new Q(b),c.map(function(f){return f.data}))))))};Jk.prototype.clone=function(a,b){b=void 0===b?this.ea:b;return new Jk(this.I,a,b)};
Jk.prototype.concat=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];var f=this.I;b=O.flatten.apply(O,[this].concat(k.o(b)));return new S(f,b.map(function(d){return new Jk(f,d.data)}))};Jk.prototype.select=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];var f=this.I.fields.reduce(function(d,e,h){return d.set(e.name,h)},new Map);return this.selectAt.apply(this,k.o(b.map(function(d){return f.get(d)}).filter(function(d){return-1<d})))};
Jk.prototype.selectAt=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];var f=this;c=this.I.selectAt.apply(this.I,k.o(b));b=b.map(function(d){return f.data.childData[d]}).filter(Boolean);return new Jk(c,this.length,b)};
k.global.Object.defineProperties(Jk.prototype,{schema:{configurable:!0,enumerable:!0,get:function(){return this.I}},numCols:{configurable:!0,enumerable:!0,get:function(){return this.I.fields.length}},dictionaries:{configurable:!0,enumerable:!0,get:function(){return this.Ba||(this.Ba=(new dn).visit(this.data,new jf(this.schema.fields)).dictionaries)}}});function Wk(a){Jk.call(this,a,0,a.fields.map(function(b){return L.new(b.type,0,0,0)}))}k.b(Wk,Jk);function dn(){this.dictionaries=new Map}k.b(dn,wd);
...
g.open=function(a){if(!this.closed&&!this.A){this.schema=(this.A=this.$b()).schema;for(var b=k.w(Oi(this.A)),c=b.next();!c.done;c=b.next())c.value&&this.Zb(this.la++)}return sn.prototype.open.call(this,a)};g.readRecordBatch=function(a){if(this.closed)return null;this.A||this.open();if((a=this.A&&this.A.Ha(a))&&this.V.seek(a.offset)){var b=this.L.readMessage(H.RecordBatch);if(b&&b.isRecordBatch())return a=b.header(),b=this.L.readMessageBody(b.bodyLength),qn(this,a,b)}return null};
g.Zb=function(a){if((a=this.A&&this.A.Hb(a))&&this.V.seek(a.offset)){var b=this.L.readMessage(H.DictionaryBatch);b&&b.isDictionaryBatch()&&(a=b.header(),b=this.L.readMessageBody(b.bodyLength),b=rn(this,a,b),this.dictionaries.set(a.id,b))}};g.$b=function(){var a=this.V,b=a.size-Gk,c=a.v(b);a=a.Ka(b-c,c);return Li.decode(a)};g.Xa=function(){this.A||this.open();if(this.A&&this.aa<this.numRecordBatches){var a=this.A&&this.A.Ha(this.aa);if(a&&this.V.seek(a.offset))return this.L.readMessage(void 0)}return null};
...
g.$b=function(){var a=this,b,c,f,d,e;return k.u(function(h){switch(h.j){case 1:b=a;c=b.V;if(!c.R){h.i(2);break}return p(h,c.R,3);case 3:case 2:return f=c.size-Gk,p(h,c.v(f),4);case 4:return d=h.m,p(h,c.Ka(f-d,d),5);case 5:return e=h.m,h.return(Li.decode(e))}})};
g.Xa=function(){var a=this,b,c;return k.u(function(f){switch(f.j){case 1:if(a.A){f.i(2);break}return p(f,a.open(),2);case 2:if(!(a.A&&a.aa<a.numRecordBatches)){f.i(4);break}b=a.A.Ha(a.aa);if(!(c=b)){f.i(5);break}return p(f,a.V.seek(b.offset),6);case 6:c=f.m;case 5:if(!c){f.i(4);break}return p(f,a.L.readMessage(void 0),8);case 8:return f.return(f.m);case 4:return f.return(null)}})};
...
Gn.prototype.Ob=function(a,b,c){var f=b.bind(a),d=c.bind(a);return function(e,h){return f(e,h)==d(e,h)}};Gn.prototype.rb=function(a,b,c){var f=b.bind(a);if(b.Na instanceof rl){var d=b.Na;if(d.dictionary!==this.Hf){var e=d.reverseLookup(c.ca);this.Hf=d.dictionary;this.If=e}else e=this.If;return-1===e?function(){return!1}:function(h){return d.getKey(h)===e}}return function(h,l){return f(h,l)==c.ca}};Gn.prototype.Pb=function(a,b,c){return this.rb(a,c,b)};function Hn(){On.apply(this,arguments)}
...
Rn.or=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];return new (Function.prototype.bind.apply(Nn,[null].concat(k.o(b))))};S.prototype.countBy=function(a){return(new Sn(this.chunks)).countBy(a)};S.prototype.scan=function(a,b){return(new Sn(this.chunks)).scan(a,b)};S.prototype.filter=function(a){return(new Sn(this.chunks)).filter(a)};function Sn(){S.apply(this,arguments)}k.b(Sn,S);Sn.prototype.filter=function(a){return new Tn(this.chunks,a)};Sn.prototype.scan=function(a,b){for(var c=this.chunks,f=c.length,d=-1;++d<f;){var e=c[d];b&&b(e);for(var h=-1,l=e.length;++h<l;)a(h,e)}};
Sn.prototype.countBy=function(a){var b=this.chunks,c=b.length;a="string"===typeof a?new Kn(a):a;a.bind(b[c-1]);var f=a.Na;if(!M.isDictionary(f.type))throw Error("countBy currently only supports dictionary-encoded columns");var d=Math.ceil(Math.log(f.length)/Math.log(256));d=new (4==d?Uint32Array:2<=d?Uint16Array:Uint8Array)(f.dictionary.length);for(var e=-1;++e<c;){var h=b[e];a.bind(h);var l=a.Na.indices,m=-1;for(h=h.length;++m<h;){var n=l.get(m);null!==n&&d[n]++}}return new Un(f.dictionary,Dl.from(d))};
function Un(a,b){var c=new Q([new P("values",a.type),new P("counts",b.type)]);S.call(this,new Jk(c,b.length,[a,b]))}k.b(Un,S);Un.prototype.toJSON=function(){for(var a=this.getColumnAt(0),b=this.getColumnAt(1),c={},f=-1;++f<this.length;)c[a.get(f)]=b.get(f);return c};k.l();k.D();function Tn(a,b){Sn.call(this,a);this.Wa=b}k.b(Tn,Sn);Tn.prototype.scan=function(a,b){for(var c=this.K,f=c.length,d=-1;++d<f;){var e=c[d];b&&b(e);for(var h=this.Wa.bind(e),l=-1,m=e.length;++l<m;)h(l,e)&&a(l,e)}};
Tn.prototype.count=function(){for(var a=0,b=this.K,c=b.length,f=-1;++f<c;)for(var d=b[f],e=this.Wa.bind(d),h=-1,l=d.length;++h<l;)e(h,d)&&++a;return a};Tn.prototype[Symbol.iterator]=function Vn(){var b=this,c,f,d,e,h,l,m;return k.C.H(Vn,function(n){1==n.j&&(c=b.K,f=c.length,d=-1);if(5!=n.j){if(!(++d<f))return n.i(0);e=c[d];h=b.Wa.bind(e);l=-1;m=e.length}return++l<m?h(l,e)?p(n,e.get(l),5):n.i(5):n.i(2)})};Tn.prototype.filter=function(a){return new Tn(this.K,this.Wa.and(a))};
Tn.prototype.countBy=function(a){var b=this.K,c=b.length;a="string"===typeof a?new Kn(a):a;a.bind(b[c-1]);var f=a.Na;if(!M.isDictionary(f.type))throw Error("countBy currently only supports dictionary-encoded columns");var d=Math.ceil(Math.log(f.length)/Math.log(256));d=new (4==d?Uint32Array:2<=d?Uint16Array:Uint8Array)(f.dictionary.length);for(var e=-1;++e<c;){var h=b[e],l=this.Wa.bind(h);a.bind(h);for(var m=a.Na.indices,n=-1,r=h.length;++n<r;){var v=m.get(n);null!==v&&l(n,h)&&d[v]++}}return new Un(f.dictionary,
